...
export default function FacilityManagementPage() {
  return (
    <div className="flex flex-col md:container md:mx-auto">
      <div className="flex flex-col gap-4 px-4 py-8 md:py-12 md:text-center max-w-4xl md:mx-auto">
      ...
      <section className="flex flex-col items-center w-full py-8 md:py-12 px-4 md:px-6 gap-6 mt-8 md:mt-12 bg-[#f5f5f5] md:bg-transparent md:flex-row md:justify-center md:gap-8">
        <div>
          <div className="flex flex-col gap-3 w-full max-w-md md:text-center">
            <h2 className="text-xl md:text-2xl font-bold text-[#339dff]">
              가상 공간의 관리
            </h2>
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300">
              메타버스 내의 건물, 인프라, 그리고 다양한 가상 시설의 운영과
              유지를 포함합니다.
            </p>
          </div>
      ...
      <section className="flex flex-col items-center w-full py-8 md:py-12 gap-6 md:gap-8 bg-[#f5f5f5] px-4 md:px-6 md:flex-row md:justify-center">
        ...
        <div className="flex flex-col gap-3 items-center bg-white w-full max-w-4xl p-6 rounded-lg shadow-sm">
          ...
          <div className="w-full aspect-[4/3] relative mt-4 md:hidden">
            <Image
      ...
      <section className="flex flex-col items-center w-full py-8 md:py-12 bg-[#f5f5f5]">
        <h2 className="text-xl md:text-2xl font-bold text-[#339dff] md:mb-8">
          기술적 요소
        </h2>
        <div className="flex flex-col gap-6 w-full max-w-4xl px-4 md:px-6 md:flex-row md:justify-center">
          <div className="flex flex-col gap-6 bg-white rounded-lg shadow-sm md:flex-1 md:justify-between">
