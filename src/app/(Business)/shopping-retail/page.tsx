...
export default function ShoppingRetailPage() {
  return (
    <div className="md:container md:mx-auto flex flex-col">
      ...
      <section className=" flex flex-col items-center w-full py-12 gap-2 mt-12 bg-[#f5f5f5] md:bg-transparent">
        <div className="flex flex-col gap-2 px-4 self-start md:text-center max-w-4xl md:self-center">
        ...
        <div className="flex flex-col self-start gap-2 px-4 mt-14 md:text-center max-w-4xl md:self-center">
      ...
      <section className=" flex flex-col items-center w-full py-12 gap-8 bg-[#f5f5f5] md:bg-transparent md:flex-row">
      ...
      <section className=" flex flex-col items-center w-full py-12 bg-[#f5f5f5] md:bg-transparent ">
        ...
        <div className="flex flex-col gap-2 w-full h-full py-5 md:text-center max-w-4xl md:self-center md:flex-row">
          <div>
            <div className="w-full flex justify-center items-center py-12 md:min-h-[200px]">
              <Image
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 items-center text-center border-t border-gray-200 pt-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                디지털 자산의 소유권과 거래를 위해 블록체인 기술과 NFT가 사용될
                수 있습니다.
              </p>
            </div>
          </div>
