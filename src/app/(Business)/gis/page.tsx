...
export default function GISPage() {
  return (
    <div className="flex flex-col">
      ...
      <section className=" flex flex-col items-center w-full py-12 px-4 gap-2 mt-12 bg-[#f5f5f5]">
        ...
        <div className="flex flex-col self-start gap-2 mt-14">
          <h2 className="text-xl font-bold text-[#339dff]">디지털 자산 보호</h2>
          <p className="text-gray-600 dark:text-gray-300">
            메타버스 내에서 구매하고 거래하는 디지털 자산 (예: NFT, 가상 부동산
            등)의 손실이나 도난을 보호합니다.
          </p>
        </div>
        <div className="w-full aspect-[4/3] relative mt-2">
